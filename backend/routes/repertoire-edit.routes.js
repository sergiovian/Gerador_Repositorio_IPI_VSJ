...
router.post('/:id/media', upload.single('file'), asyncHandler(async (req, res) => res.status(201).json({ data: await Service.saveMedia(req.params.id, req.file) })));
router.get('/:id/media/:file', asyncHandler(async (req, res) => res.sendFile(await Service.getMedia(req.params.id, req.params.file))));
